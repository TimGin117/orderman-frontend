...
export default class StocksForm extends Component {
  ...
  validateAllFormField = () => {
    this.refs.form.validateAll((errors, values) => {
      ...
      axios.post('http://localhost:8080/stocks/add',
        values
        ).then(response =>{
        ...
        <IceContainer style={{ padding: '40px' }}>
          ...
          >
            <div style={styles.formItem}>
              <div style={styles.formLabel}>商家编号：</div>
              <IceFormBinder name="sellerId" required message="商家编号必填">
               <NumberPicker />
              </IceFormBinder>
            ...
            <div style={styles.formItem}>
              <div style={styles.formLabel}>商品编号：</div>
              <IceFormBinder name="goodsId" required message="商品编号必填">
                <NumberPicker />
              </IceFormBinder>
              <div style={styles.formError}>
